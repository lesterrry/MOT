...
const handleButtonClick = (id) => {
	...
	case 1:  // all exhibits
		...
		break
	case 2:  // about
		showOverlay(['Что это', 'МУВР — часть проекта «скип» — компании, производящей приборы для изменения времени. Для ознакомления со всем проектом нажмите на логотип МУВР в нижнем меню.'])
		break
	case 3:  // help
